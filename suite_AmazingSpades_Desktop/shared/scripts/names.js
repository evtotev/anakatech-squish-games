...
export var game_tab = {"title": "SF`217", "type": "BrowserTab"};
...
export var game_coordinates = "{title='SF`275' type='BrowserTab'}.DOCUMENT.HTML1.BODY1.DIV2.DIV1.DIV2.DIV1.DIV1.DIV3.DIV3.DIV1.DIV1.svg1.g1.g1.path1";
...
export var bet_more = {"container": game_tab, "id": "BetMore_", "tagName": "path", "visible": true};
export var close_error = {"container": game_tab, "simplifiedInnerText": "Close", "tagName": "BUTTON", "type": "submit", "visible": true};
export var bet_less = {"container": game_tab, "id": "BetLess_", "tagName": "path", "visible": true};
export var play_btn = {"container": game_tab, "id": "btn_play", "tagName": "div", "visible": true};
export var play_for_me_btn = {"container": game_tab, "id": "btn_fast_play", "tagName": "div", "visible": true};
...
export var turbo_btn = {"container": game_tab, "id": "turbo_switch", "tagName": "div"};
...
export var error_title = {"container": game_tab, "class": "title", "tagName" : "section"};
...
export var lossLimit_error = "{title='SF`217' type='BrowserTab'}.DOCUMENT.HTML1.BODY1.DIV5.DIV1.DIV1.SECTION1";
export var infoPage = "{title='SF`217' type='BrowserTab'}.DOCUMENT.HTML1.BODY1.DIV2.DIV1.DIV2.DIV1.DIV3.DIV3.svg1.g1.path1";
